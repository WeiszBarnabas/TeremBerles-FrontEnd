...
const formData = ref({
  ...
  logistics: {
    ...
    wasteHandler: "",
    internetNeeded: null,
    techSupportNeeded: null,
    techEquipment: "",
    securityServiceNeeded: null
  },
  additionalRequirements: {
    limitedMobility: null,
    photoVideoRecording: null,
    recordingTools: "",
    cateringNeeded: null,
    cateringType: [],
    constructionNeeded: null,
    constructionDates: {
      startDate: "",
      startTime: "",
      endDate: "",
    ...
    subcontractors: "",
    highAltitudeWork: null,
    scaffoldingNeeded: null,
    manualMaterialHandling: null,
    mechanicalMaterialHandling: null,
    mechanicalEquipment: [],
    mechanicalOtherTool: "",
    cleaningBefore: null,
    cleaningDuring: null,
    ...
    powerCabinet: null,
    powerDemand: "",
    includeInEventRecommendation: null,
    includeInCentralCalendar: null
  },
  safetyCompliance: {
    fireHazard: null,
...
<template>
  <ApplicationLayout>
    <div class="bg-white max-w-5xl w-full mx-auto p-6 rounded-lg shadow-lg">
      ...
      <div v-if="showSuccessToast" id="toast-success" class="fixed bottom-4 right-4 flex items-center w-full max-w-xs p-4 text-gray-500 bg-white rounded-lg shadow-sm" role="alert">
        ...
        <div class="ms-3 text-sm font-normal">Űrlap sikeresen elküldve!</div>
        <button type="button" @click="showSuccessToast = false; currentStep = 1" class="ms-auto -mx-1.5 -my-1.5 bg-white text-gray-400 hover:text-gray-900 rounded-lg focus:ring-2 focus:ring-gray-300 p-1.5 hover:bg-gray-100 inline-flex items-center justify-center h-8 w-8" aria-label="Close">
