...
<template>
  <ApplicationLayout>
    <div class="bg-white max-w-5xl w-full mx-auto p-6 rounded-lg shadow-lg">
      ...
      <FormLayout>
        ...
        <div v-if="currentStep === 1" class="space-y-6">
          ...
          <div class="space-y-6">
            ...
            <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
              ...
              <div class="block sm:w-3/4 w-full mt-2 sm:mt-0 space-y-2">
                <label class="flex items-center"><input v-model="formData.eventType" class="mr-2" type="radio" value="university"> Egyetemi szervezésű rendezvények</label>
                <label class="flex items-center"><input v-model="formData.eventType" class="mr-2" type="radio" value="student"> Hallgatói rendezvények</label>
                <label class="flex items-center"><input v-model="formData.eventType" class="mr-2" type="radio" value="external"> Külső szervezésű rendezvények</label>
                <label class="flex items-center"><input v-model="formData.eventType" class="mr-2" type="radio" value="sports"> Sportrendezvények</label>
              </div>
            </div>
            <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
        ...
        <div v-if="currentStep === 2" class="space-y-6">
          ...
          <div class="space-y-6">
            <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
              ...
              <TextInput v-model="formData.specifics.participants" type="number" class="bg-gray-100 border border-gray-300 rounded-md p-2 text-black block sm:w-3/4 w-full mt-2 sm:mt-0" />
            </div>
            <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
              <div class="sm:w-1/3 w-full font-medium text-black text-base">Sajtónyilvános rendezvény? <span class="text-red-600">*</span></div>
              <div class="block sm:w-3/4 w-full mt-2 sm:mt-0 space-y-2">
                <label class="flex items-center"><input v-model="formData.specifics.pressPublic" type="radio" value="yes" class="mr-2"> Igen</label>
                <label class="flex items-center"><input v-model="formData.specifics.pressPublic" type="radio" value="no" class="mr-2"> Nem</label>
              </div>
            </div>
            <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
        ...
        <div v-if="currentStep === 3" class="space-y-6">
          ...
          <div class="space-y-6">
            <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
              ...
              <div class="block sm:w-3/4 w-full mt-2 sm:mt-0 space-y-2">
                <label class="flex items-center"><input v-model="formData.logistics.accommodationNeeded" type="radio" value="yes" class="mr-2"> Igen</label>
                <label class="flex items-center"><input v-model="formData.logistics.accommodationNeeded" type="radio" value="no" class="mr-2"> Nem</label>
              </div>
            </div>
            <div v-if="formData.logistics.accommodationNeeded === 'yes'" class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
            ...
            <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
              ...
              <div class="block sm:w-3/4 w-full mt-2 sm:mt-0 space-y-2">
                <label class="flex items-center"><input v-model="formData.logistics.parkingNeeded" type="radio" value="yes" class="mr-2"> Igen</label>
                <label class="flex items-center"><input v-model="formData.logistics.parkingNeeded" type="radio" value="no" class="mr-2"> Nem</label>
              </div>
            </div>
            <div v-if="formData.logistics.parkingNeeded === 'yes'" class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
        ...
        <div v-if="currentStep === 4" class="space-y-6">
          ...
          <div class="space-y-6">
            <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
              ...
              <div class="block sm:w-3/4 w-full mt-2 sm:mt-0 space-y-2">
                <label class="flex items-center"><input v-model="formData.logistics.wasteGenerated" type="radio" value="yes" class="mr-2"> Igen</label>
                <label class="flex items-center"><input v-model="formData.logistics.wasteGenerated" type="radio" value="no" class="mr-2"> Nem</label>
              </div>
            </div>
            <div v-if="formData.logistics.wasteGenerated === 'yes'" class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
        ...
        <div v-if="currentStep === 5" class="space-y-6">
          ...
          <div class="space-y-6">
            <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
              ...
              <div class="block sm:w-3/4 w-full mt-2 sm:mt-0 space-y-2">
                <label class="flex items-center"><input v-model="formData.logistics.internetNeeded" type="radio" value="yes" class="mr-2"> Igen</label>
                <label class="flex items-center"><input v-model="formData.logistics.internetNeeded" type="radio" value="no" class="mr-2"> Nem</label>
              </div>
            </div>
            <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
            ...
            <div class="rounded-md p-2 text-black block sm:w-3/4 w-full mt-2 sm:mt-0">
             <label class="flex items-center"><input v-model="formData.logistics.techSupportNeeded" type="radio" value="yes" class="mr-2"> Igen</label>
             <label class="flex items-center"><input v-model="formData.logistics.techSupportNeeded" type="radio" value="no" class="mr-2"> Nem</label>
             </div>
            </div>
        ...
        <div v-if="currentStep === 6" class="space-y-6">
          ...
          <div class="space-y-6">
            <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
              ...
              <div class="block sm:w-3/4 w-full mt-2 sm:mt-0 space-y-2">
                <label class="flex items-center"><input v-model="formData.additionalRequirements.limitedMobility" type="radio" value="yes" class="mr-2"> Igen</label>
                <label class="flex items-center"><input v-model="formData.additionalRequirements.limitedMobility" type="radio" value="no" class="mr-2"> Nem</label>
              </div>
            </div>
            <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
            <div class="sm:w-1/3 w-full font-medium text-black text-base">
            ...
            <div class="rounded-md p-2 text-black block sm:w-3/4 w-full mt-2 sm:mt-0">
                <label class="flex items-center"><input v-model="formData.additionalRequirements.photoVideoRecording" type="radio" value="yes" class="mr-2"> Igen</label>
             <label class="flex items-center"><input v-model="formData.additionalRequirements.photoVideoRecording" type="radio" value="no" class="mr-2"> Nem</label>
             </div>
            </div>
            <div class="sm:w-3/4 w-full text-sm text-gray-500 mt-1">
            ...
            <div v-if="formData.additionalRequirements.photoVideoRecording === 'yes'" class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
            ...
            <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
              ...
              <div class="block sm:w-3/4 w-full mt-2 sm:mt-0 space-y-2">
                <label class="flex items-center"><input v-model="formData.additionalRequirements.cateringNeeded" type="radio" value="yes" class="mr-2"> Igen</label>
                <label class="flex items-center"><input v-model="formData.additionalRequirements.cateringNeeded" type="radio" value="no" class="mr-2"> Nem</label>
              </div>
            </div>
            <div v-if="formData.additionalRequirements.cateringNeeded === 'yes'" class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
            ...
            <div v-if="formData.additionalRequirements.cateringNeeded === 'yes'" class="sm:w-3/4 w-full text-sm text-gray-500 mt-1">Egyetemi catering partnerekkel egyeztetünk.</div>
          </div>
        </div>
        ...
        <div v-if="currentStep === 7" class="space-y-6">
          ...
          <div class="space-y-6">
            <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
              ...
              <div class="block sm:w-3/4 w-full mt-2 sm:mt-0 space-y-2">
                <label class="flex items-center"><input v-model="formData.additionalRequirements.constructionNeeded" type="radio" value="yes" class="mr-2"> Igen</label>
                <label class="flex items-center"><input v-model="formData.additionalRequirements.constructionNeeded" type="radio" value="no" class="mr-2"> Nem</label>
              </div>
            </div>
            <div v-if="formData.additionalRequirements.constructionNeeded === 'yes'" class="space-y-6">
              ...
              <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
                ...
                <div class="block sm:w-3/4 w-full mt-2 sm:mt-0 space-y-2">
                  <label class="flex items-center"><input v-model="formData.additionalRequirements.highAltitudeWork" type="radio" value="yes" class="mr-2"> Igen</label>
                  <label class="flex items-center"><input v-model="formData.additionalRequirements.highAltitudeWork" type="radio" value="no" class="mr-2"> Nem</label>
                </div>
              </div>
              <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
                <div class="sm:w-1/3 w-full font-medium text-black text-base">Állvány szükséges? <span class="text-red-600">*</span></div>
                <div class="block sm:w-3/4 w-full mt-2 sm:mt-0 space-y-2">
                  <label class="flex items-center"><input v-model="formData.additionalRequirements.scaffoldingNeeded" type="radio" value="yes" class="mr-2"> Igen</label>
                  <label class="flex items-center"><input v-model="formData.additionalRequirements.scaffoldingNeeded" type="radio" value="no" class="mr-2"> Nem</label>
                </div>
              </div>
              <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
                <div class="sm:w-1/3 w-full font-medium text-black text-base">Kézi anyagmozgatás? <span class="text-red-600">*</span></div>
                <div class="block sm:w-3/4 w-full mt-2 sm:mt-0 space-y-2">
                  <label class="flex items-center"><input v-model="formData.additionalRequirements.manualMaterialHandling" type="radio" value="yes" class="mr-2"> Igen</label>
                  <label class="flex items-center"><input v-model="formData.additionalRequirements.manualMaterialHandling" type="radio" value="no" class="mr-2"> Nem</label>
                </div>
              </div>
              <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
                <div class="sm:w-1/3 w-full font-medium text-black text-base">Gépi anyagmozgatás? <span class="text-red-600">*</span></div>
                <div class="block sm:w-3/4 w-full mt-2 sm:mt-0 space-y-2">
                  <label class="flex items-center"><input v-model="formData.additionalRequirements.mechanicalMaterialHandling" type="radio" value="yes" class="mr-2"> Igen</label>
                  <label class="flex items-center"><input v-model="formData.additionalRequirements.mechanicalMaterialHandling" type="radio" value="no" class="mr-2"> Nem</label>
                </div>
              </div>
              <div v-if="formData.additionalRequirements.mechanicalMaterialHandling === 'yes'" class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
            ...
            <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
              ...
              <div class="block sm:w-3/4 w-full mt-2 sm:mt-0 space-y-2">
                <label class="flex items-center"><input v-model="formData.additionalRequirements.cleaningBefore" type="radio" value="yes" class="mr-2"> Igen</label>
                <label class="flex items-center"><input v-model="formData.additionalRequirements.cleaningBefore" type="radio" value="no" class="mr-2"> Nem</label>
              </div>
            </div>
            <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
              ...
              <div class="block sm:w-3/4 w-full mt-2 sm:mt-0 space-y-2">
                <label class="flex items-center"><input v-model="formData.additionalRequirements.cleaningDuring" type="radio" value="yes" class="mr-2"> Igen</label>
                <label class="flex items-center"><input v-model="formData.additionalRequirements.cleaningDuring" type="radio" value="no" class="mr-2"> Nem</label>
              </div>
            </div>
            <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
            ...
            <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
              ...
              <div class="block sm:w-3/4 w-full mt-2 sm:mt-0 space-y-2">
                <label class="flex items-center"><input v-model="formData.additionalRequirements.powerCabinet" type="radio" value="yes" class="mr-2"> Igen</label>
                <label class="flex items-center"><input v-model="formData.additionalRequirements.powerCabinet" type="radio" value="no" class="mr-2"> Nem</label>
              </div>
            </div>
            <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
        ...
        <div v-if="currentStep === 8" class="space-y-6">
          ...
          <div class="space-y-6">
            <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
              ...
              <div class="block sm:w-3/4 w-full mt-2 sm:mt-0 space-y-2">
                <label class="flex items-center"><input v-model="formData.safetyCompliance.fireHazard" type="radio" value="yes" class="mr-2"> Igen</label>
                <label class="flex items-center"><input v-model="formData.safetyCompliance.fireHazard" type="radio" value="no" class="mr-2"> Nem</label>
              </div>
            </div>
            <div v-if="formData.safetyCompliance.fireHazard === 'yes'" class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
            ...
            <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
              ...
              <div class="block sm:w-3/4 w-full mt-2 sm:mt-0 space-y-2">
                <label class="flex items-center"><input v-model="formData.safetyCompliance.chemicalUsage" type="radio" value="yes" class="mr-2"> Igen</label>
                <label class="flex items-center"><input v-model="formData.safetyCompliance.chemicalUsage" type="radio" value="no" class="mr-2"> Nem</label>
              </div>
            </div>
            <div v-if="formData.safetyCompliance.chemicalUsage === 'yes'" class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
            ...
            <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
              ...
              <div class="block sm:w-3/4 w-full mt-2 sm:mt-0 space-y-2">
                <label class="flex items-center"><input v-model="formData.safetyCompliance.decorations" type="radio" value="yes" class="mr-2"> Igen</label>
                <label class="flex items-center"><input v-model="formData.safetyCompliance.decorations" type="radio" value="no" class="mr-2"> Nem</label>
              </div>
            </div>
          </div>
        </div>
        ...
        <div v-if="currentStep === 9" class="space-y-6">
          ...
          <div class="space-y-6">
            ...
            <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
              ...
              <div class="block sm:w-3/4 w-full mt-2 sm:mt-0 space-y-2">
                <label class="flex items-center"><input v-model="formData.organizerDetails.additionalOrganizer" type="radio" value="yes" class="mr-2"> Igen</label>
                <label class="flex items-center"><input v-model="formData.organizerDetails.additionalOrganizer" type="radio" value="no" class="mr-2"> Nem</label>
              </div>
            </div>
       ...
       <div class="sm:w-3/4 w-full">
         <input type="file" @change="formData.fileUploads.eventNotificationForm = $event.target.files[0]" class="bg-gray-100 border border-gray-300 rounded-md p-2 text-black w-full mt-2 sm:mt-0" />
    ...
    Helyszín berendezési rajz (opcionális)
        ...
        <div class="sm:w-3/4 w-full">
         <input type="file" @change="formData.fileUploads.venueLayout = $event.target.files[0]" class="bg-gray-100 border border-gray-300 rounded-md p-2 text-black w-full mt-2 sm:mt-0" />
         <div class="text-sm text-gray-500 mt-1">Max. méret 6Mb</div>
       </div>
      </div>
      ...
      <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
       ...
       <div class="sm:w-3/4 w-full">
          ...
          <div class="text-sm text-gray-500 mt-1">
           Az űrlap kitöltésével büntetőjogi felelősségem tudatában kijelentem, hogy az adatok valósak, és hozzájárulok az adatkezeléshez a 1992. évi LXIII. törvény szerint.
          </div>
        </div>
      </div>
      ...
      <div class="mb-4 flex flex-col sm:flex-row items-start sm:items-center">
         <div class="sm:w-1/3 w-full font-medium text-black text-base">
          ...
          <div class="text-sm text-gray-500 mt-1">
            A szabályzat <a href="https://munkatars.sze.hu/downloadmanager/details/id/43020/m/13936" target="_blank" class="text-blue-500">ide kattintva</a> érhető el.
          </div>
       </div>
      </div>
